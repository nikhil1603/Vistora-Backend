...
export const getAllProducts = TryCatch(async (req, res) => {
    ...
    const products = await Product.find(fliter).sort(sortOption).limit(limit).skip(skip);
  ...
  export const getSinleProduct = TryCatch(async (req, res) => {
